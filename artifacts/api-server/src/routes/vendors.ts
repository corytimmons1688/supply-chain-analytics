...
const VENDOR_UPDATABLE_KEYS = [
  ...
  "waveSprint", "productCategories", "specInDate", "specInLink", "shortlistDate", "shortlistLink",
  "creditCheckDate", "creditCheckLink",
  "ndaLink", "assessmentDate", "assessmentLink", "qualityAgreementDate",
  "qualityAgreementLink", "supplierSelectedDate", "supplierSelectedLink",
  "factoryAuditLink", "netsuiteSetupDate", "netsuiteSetupLink",
  "poReadyDate", "poReadyLink", "msaLink", "ndaDate", "msaDate", "capabilityVerified", "factoryTourDate",
...
function vendorOut(r: VendorRow) {
  return {
    ...
    shortlistDate: r.shortlistDate,
    shortlistLink: r.shortlistLink,
    creditCheckDate: r.creditCheckDate,
    creditCheckLink: r.creditCheckLink,
    ndaLink: r.ndaLink,
    assessmentDate: r.assessmentDate,
    assessmentLink: r.assessmentLink,
    qualityAgreementDate: r.qualityAgreementDate,
    qualityAgreementLink: r.qualityAgreementLink,
    supplierSelectedDate: r.supplierSelectedDate,
    supplierSelectedLink: r.supplierSelectedLink,
    factoryAuditLink: r.factoryAuditLink,
    netsuiteSetupDate: r.netsuiteSetupDate,
    netsuiteSetupLink: r.netsuiteSetupLink,
